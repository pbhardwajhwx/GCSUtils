...
// Check if the KB is Public or not, if not Public alert the user that this cannot be sent to customer
// send message to the background script on the access level
...
if(isPublic()) {
	...
	copyTextToClipboard(externalURL);
	chrome.runtime.sendMessage({access: "Public", urlKB: externalURL},{},function(){});
} else {
	chrome.runtime.sendMessage({access: "Internal", urlKB: null},{},function(){});
}