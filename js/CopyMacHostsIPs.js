...
var hostnames = [];
$(".trim_hostname a").each(function(){hostnames.push($(this).text())});

var ips = [];
$(".host-ip").each(function(){ips.push($(this).text())});

var commandPrivateEtcHosts = "sudo tee -a /Private/etc/hosts <<EOF";
